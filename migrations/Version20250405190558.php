 ...
 */
final class Version20250405190558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_ue (user_id INT NOT NULL, ue_id INT NOT NULL, INDEX IDX_361EBE5EA76ED395 (user_id), INDEX IDX_361EBE5E62E883B1 (ue_id), PRIMARY KEY(user_id, ue_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
