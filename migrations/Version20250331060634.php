 ...
 */
final class Version20250331060634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ue ADD id_ue INT AUTO_INCREMENT NOT NULL, DROP idUE, CHANGE code_ue code_ue INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_ue)');
    }
